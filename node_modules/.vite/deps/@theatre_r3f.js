...
import {
  ...
  SpotLightHelper,
  Vector3
} from "./chunk-F3CFLUSB.js";
import {
  require_react
} from "./chunk-YN3MIK7E.js";
import {
  require_dist
} from "./chunk-YREEWGGT.js";
import {
  __toESM
...
var SheetProvider = ({ sheet, children }) => {
  ...
  return import_react3.default.createElement(ctx.Provider, {
    value: { sheet }
  }, children);
};
...
var createEditable = (config2) => {
  const editable2 = (Component, type) => {
    ...
    return (0, import_react2.forwardRef)((_a, ref) => {
      ...
      const storeKey = (0, import_react.useMemo)(() => makeStoreKey(__spreadProps(__spreadValues({}, sheet.address), {
      ...
      (0, import_react2.useEffect)(() => {
        if (Component === "perspectiveCamera" || Component === "orthographicCamera") {
          ...
          import_core3.notify.warning(`Possibly incorrect use of <e.${Component} />`, `You seem to have declared the camera "${theatreKey}" simply as \`<e.${Component} ... />\`. This alone won't make r3f use it for rendering.
...
`);
      ...
      return import_react2.default.createElement(Component, __spreadProps(__spreadValues({
...
var PerspectiveCamera = editable_default((0, import_react5.forwardRef)((_a, ref) => {
  ...
  const cameraRef = (0, import_react5.useRef)(null);
  ...
  return (0, import_react5.createElement)("perspectiveCamera", __spreadValues({
    ref: react_merge_refs_esm_default([cameraRef, ref])
  }, props));
}), "perspectiveCamera");
var OrthographicCamera = editable_default((0, import_react6.forwardRef)((_a, ref) => {
  var _b = _a, { makeDefault, lookAt } = _b, props = __objRest(_b, ["makeDefault", "lookAt"]);
  const set = useThree(({ set: set2 }) => set2);
  const camera = useThree(({ camera: camera2 }) => camera2);
  const size = useThree(({ size: size2 }) => size2);
  ...
  return (0, import_react6.createElement)("orthographicCamera", __spreadValues({
    left: size.width / -2,
    right: size.width / 2,
    top: size.height / 2,
